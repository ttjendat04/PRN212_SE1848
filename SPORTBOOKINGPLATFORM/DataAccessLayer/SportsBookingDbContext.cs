...
public partial class SportsBookingDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.BookingId).HasName("PK__Bookings__73951ACDCB4E56CF");
            ...
            entity.HasOne(d => d.Court).WithMany(p => p.Bookings)
                ...
                .HasConstraintName("FK__Bookings__CourtI__412EB0B6");
        ...
        {
            entity.HasKey(e => e.CourtId).HasName("PK__Courts__C3A67CFAADB7FF55");
            ...
            entity.HasOne(d => d.Sport).WithMany(p => p.Courts)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Courts__SportID__44FF419A");
        ...
        {
            entity.HasKey(e => e.ReviewId).HasName("PK__CourtRev__74BC79AEEFD94EE4");
            ...
            entity.HasOne(d => d.Court).WithMany(p => p.CourtReviews)
                .HasForeignKey(d => d.CourtId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__CourtRevi__Court__4316F928");

            entity.HasOne(d => d.User).WithMany(p => p.CourtReviews)
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__CourtRevi__UserI__440B1D61");
        });

        modelBuilder.Entity<CourtStatus>(entity =>
        {
            entity.HasKey(e => e.StatusId).HasName("PK__CourtSta__C8EE2043762E6AA4");
        ...
        {
            entity.HasKey(e => e.NotificationId).HasName("PK__Notifica__20CF2E32E7FF28F1");
        ...
        {
            entity.HasKey(e => e.RoleId).HasName("PK__Roles__8AFACE3AE4BC631A");
        ...
        {
            entity.HasKey(e => e.SportId).HasName("PK__Sports__7A41AF1C0B3B5549");
        ...
        {
            entity.HasKey(e => e.LogId).HasName("PK__SystemLo__5E5499A89CF653F9");
        ...
        {
            entity.HasKey(e => e.TournamentId).HasName("PK__Tourname__AC631333797D540B");

            entity.Property(e => e.TournamentId).HasColumnName("TournamentID");
            entity.Property(e => e.IsTeamBased).HasDefaultValue(false);
            entity.Property(e => e.Location).HasMaxLength(255);
            ...
            entity.HasOne(d => d.Organizer).WithMany(p => p.Tournaments)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Tournamen__Organ__4AB81AF0");

            entity.HasOne(d => d.Sport).WithMany(p => p.Tournaments)
                .HasForeignKey(d => d.SportId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Tournamen__Sport__4BAC3F29");
        });

        modelBuilder.Entity<TournamentRegistration>(entity =>
        {
            entity.HasKey(e => e.RegistrationId).HasName("PK__Tourname__6EF58830D4889DE5");
            ...
            entity.HasOne(d => d.Tournament).WithMany(p => p.TournamentRegistrations)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Tournamen__Tourn__48CFD27E");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__Users__1788CCAC5901EBA7");

            entity.HasIndex(e => e.Email, "UQ__Users__A9D1053449E4858F").IsUnique();
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__UserProf__1788CCACEC17FC44");
            ...
            entity.HasOne(d => d.User).WithOne(p => p.UserProfile)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__UserProfi__UserI__4CA06362");
        });
